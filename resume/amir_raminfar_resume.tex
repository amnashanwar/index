...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Clashleaders.com}
      {Web app written in VueJs, Python DataFrames and Docker to track see trends and leaderboard for the Clash of Clan game. Total of 5,000 monthly active users.}
  \resumeSubHeadingListEnd
